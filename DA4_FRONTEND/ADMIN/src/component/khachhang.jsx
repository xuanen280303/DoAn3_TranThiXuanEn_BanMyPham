            ...
            <div className="bodybenphaimp"> 
                <div className="headerbaiviet">
                    <div style={{display: "flex"}}>
                        <p style={{fontSize: "25px", marginLeft: "450px"}}>QUẢN LÝ KHÁCH HÀNG</p>
                    </div>          
                ...
                <div className="phantren">
                    <div className="phantren1">
                        <div className="nhap-thongtin">
                            <h3 className="text-header"><i className="fa-solid fa-pen-to-square" style={{color: "#ff6600"}}></i>Nhập thông tin khách hàng</h3>
                            <form className="nhap-thongtin-sp">
                                <label htmlFor="MaMP" className="txtmasp">Mã khách hàng: </label>
                                ...
                                <input id="tieudebv" type="text" style={{width: "347px"}} placeholder="Nhập tiêu đề khách hàng..."/>
                            </form>                  
                        </div>      
                        <div className="nhap-thongtin">
                            <form className="nhap-thongtin-sp" style={{marginTop: "80px"}}>
                                <label htmlFor="TenMP" className="txtmasp">Số điện thoại: </label>
                                <input id="nguoidangbv" type="text" style={{width: "347px"}} placeholder="Nhập tên người đăng khách hàng..."/>         
                                <label htmlFor="TenMP" className="txtmasp">Địa chỉ: </label>
                                <input id="tgiandangbv" type="text" style={{width: "347px"}} placeholder="Nhập thời gian đăng khách hàng..."/>         
                            </form>                  
                        </div>   
                    </div>            
                ...
                <div className="phanduoi">
                    <div className="header-ds">
                        <h3 className="text-header" style={{marginLeft: "20px"}}><i className="fa-solid fa-list-ul"></i> Danh sách khách hàng</h3>
                    </div>
                    <div className="searchs">
                        <input type="text" placeholder="Nhập mã, tiêu đề khách hàng cần tìm kiếm..." style={{width: "1000px"}}/>
                    ...
                    <table className="table-ds-sp">
                        ...
                        <tbody id="tbody_baiviet">
                            <tr style={{height: "40px", fontSize: "16px"}}>
                                ...
                                <td className="col-mamp" style={{paddingTop: "10px"}}>KH01</td>
                                <td className="col-tenmp" style={{paddingTop: "10px"}}>Trần Thị Xuân Én</td>
